...
public class FratOrgaFragment extends CustomFragment {
    private static final String TAG = "FratOrgaFragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((Toolbar) requireActivity().findViewById(R.id.toolbar)).setTitle(R.string.menu_more_frat_organisation);
